...
label s1scene5:
    ...
    s "Ух. Надеюсь, нам с папой не придется брать кредит."
...
label s1scene6:
    ...
    sm "Они развязывают мои шнурки, серьезно? Что за ребячество! Ооо. Кто-то расстегивает мне ширинку? Ха! Недурно. Надеюсь, это делает девушка. Да, это точно девушка. Какой нежный телекинез. Это точно буллинг?"

    n "Ха,ха,ха!!!"

    teacher "Что вы творите? Прекратите!"

    s "Не думаю, что кто-то здесь станет утруждаться запоминать мое имя. "

    sm "Хм. И что это касается моей спины? Пишут что-то у меня на спине мелом? "
    extend " Ладно, хватит игр! Сосредоточиться! Раз, два, три… Больше концентрации. Собрать в пальцах. Та-дам."
    ...
    s "Да, мне это рассказали. Но, видимо, мне забыли рассказать, что я единственный в этой школе, кому запрещено баловаться магией."
    ...
    s "Что ж. Вы сейчас все думаете, о том, что я не один из вас. И что я никогда не стану одним из вас. Так вот, знайте - я и не собираюсь. И я не надеюсь, что мы подружимся. Давайте просто не будем донимать друг друга."
...
label s1scene7:
    ...
    sm "Каким бы дерьмом не были люди в этой школе, уроки здесь действительно другого уровня. Было непросто…"

    play music "audio/magic-soundtrack-naptyajenie.mp3" fadein(1.0)

    sm "О, меня уже ждут. Не ожидал, что стану им так интересен в первый же день. "
    ...
    sm "Черт! Это было неожиданно!"

    s "Разве плохие парни перед дракой не должны сначала произнести длинную торжественную речь?"  

    ps "Вжарьте ему еще раз! Кажется, он с первого раза не понял."

    sm "Это явно их предводитель. Знакомое лицо. Я точно видел его, когда читал о школе. "

    sm "Собрать всю энергию… Поднять, сконцентрировать, усилить. Взять силу камней. Есть ли рядом металл? Забор… Сойдет. Взять силу металла. Теперь в глаза… Стена… Готово. Главное не моргнуть."
    ...
    sm "Вспомнил. Он же девятый сын президента, его четырнадцатый ребенок. "

    s "Так вот как развлекаются дети президента. Отличный сюжет для новостей. "

    ps "Вы что, втроем не можете справится с этим отбросом? "

    sm "Вот сейчас точно не стоит моргать! "

    # удар, тряска, черный экран
    with hpunch
    with vpunch

    sm "Он смог пробить стену… "
    ...
    s "Но знаешь, есть кое-что странное. Это была энергия трех разных людей. И это не твои дружки. "
    ...
    s "А ты еще мне не поверил? Ладно. Давай, ударь меня еще раз. "
    ...
    s "Очевидно, что ты знаешь не всех. Лучше держись от меня подальше. Иначе я не стану молчать. "
    ...
    s "А ты явно много мной интересовался. Даже моими родителями… Думаю, что теперь я тебе интересен еще больше. "
...
label s1scene8:
    ...
    s "Значит, если человека убить в тот момент, когда он применяет свою энергию, можно получить его энергию себе?"
    ...
    s "Но я же непервый в мире ребенок, чья мама умерла после родов."
    ...
    s "О моем случае мир тоже не знает."
    ...
    s "Значит, я должен всю жизнь скрывать свою двойную энергию?"
    ...
    sm "Откуда у сына короля три базиса?"

    if not block_used:
        sm "И все три базиса явно не его. Свой он не использует. Он точно не добрый парень, ни девушка и ни мужчина средних лет. У него вообще есть свой базис?"
    else:
        sm "У него два чужих базиса. А это уже не похоже на мой случай."

    sm "Хотя вместе их сила была достаточной, по отдельности это довольно слабые  энергии… Все это очень странно."
