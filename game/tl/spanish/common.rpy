...
translate spanish strings:
    ...
    new "Voz de portapapeles habilitada. "
    ...
    new "Menú de accesibilidad. Utiliza las flechas arriba y abajo para navegar, y enter para activar botones y barras."
    ...
    new "El soporte de auto-voz es limitado cuando se utiliza una pantalla táctil."
    ...
    new "Disminución de volumen de auto-voz"

    # renpy/common/00accessibility.rpy:237
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Las opciones en este menú están destinadas a mejorar la accesibilidad. Es posible que no funcionen con todos los juegos, y algunas combinaciones de opciones pueden hacer que el juego sea injugable. Esto no es un problema con el juego o el motor. Para obtener los mejores resultados al cambiar fuentes, intenta mantener el tamaño del texto igual que originalmente era."
    ...
    new "¿Estás seguro de que deseas sobrescribir tu guardado?"

    # renpy/common/00gui.rpy:451
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Cargar perderá el progreso no guardado.\n¿Estás seguro de que deseas hacer esto?"

    # renpy/common/00gui.rpy:452
    old "Are you sure you want to quit?"
    new "¿Estás seguro de que deseas salir?"

    # renpy/common/00gui.rpy:453
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "¿Estás seguro de que deseas regresar al menú principal?\nEsto perderá el progreso no guardado."

    # renpy/common/00gui.rpy:454
    old "Are you sure you want to continue where you left off?"
    new "¿Estás seguro de que deseas continuar desde donde te quedaste?"

    # renpy/common/00gui.rpy:455
    old "Are you sure you want to end the replay?"
    new "¿Estás seguro de que deseas terminar la repetición?"
    ...
    new "¿Estás seguro de que deseas saltar a la próxima elección?"

    # renpy/common/00gui.rpy:458
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "¿Estás seguro de que deseas saltar el diálogo no visto hasta la próxima elección?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Este guardado fue creado en un dispositivo diferente. Los archivos de guardado maliciosamente construidos pueden dañar tu computadora. ¿Confías en el creador de este guardado y en todos los que podrían haber cambiado el archivo?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "¿Confías en el dispositivo en el que se creó el guardado? Debes elegir sí solo si eres el único usuario del dispositivo."
    ...
    new "Este programa contiene software libre bajo un número de licencias, incluyendo la Licencia MIT y la Licencia Pública General Reducida de GNU. Una lista completa de software, incluyendo enlaces al código fuente completo, se puede encontrar {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    new "deshabilitar voz de depuración"
    ...
    new "La auto-vocalización diría \"[renpy.display.tts.last]\". Presione 'alt+shift+V' para deshabilitar."

    # renpy/common/00preferences.rpy:705
    old "Self-voicing enabled. Press 'v' to disable."
    new "Auto-vocalización habilitada. Presione 'v' para deshabilitar."
    ...
    new "El servidor de sincronización de Ren'Py no tiene una copia de esta sincronización. El ID de sincronización puede ser inválido, o puede haber agotado el tiempo de espera."
    ...
    new "Esto subirá sus partidas guardadas al {a=https://sync.renpy.org}Servidor de Sincronización de Ren'Py{/a}.\n¿Desea continuar?"
    ...
    new "Puede usar este ID para descargar su partida en otro dispositivo.\nEsta sincronización expirará en una hora.\nRen'Py Sync es compatible con {a=https://www.renpy.org/sponsors.html}los patrocinadores de Ren'Py{/a}."
    ...
    new "O bien este proyecto no admite actualizaciones, o el archivo de estado de la actualización fue eliminado."
    ...
    new "Preparando para descargar los datos del juego."
    ...
    new "Este ordenador está utilizando renderización de software."
    ...
    new "Es posible que los controladores de gráficos estén desactualizados o no funcionen correctamente. Esto puede provocar una visualización lenta o incorrecta de los gráficos."

    # renpy/common/00gltest.rpy:261
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información para ayudarle a determinar qué está mal con su ordenador."
    ...
    new "Cambiar opciones de renderización"
    ...
    new "Copia el archivo traceback.txt al portapapeles como código BB para foros como https://lemmasoft.renai.us/."
    ...
    new "Intenta retroceder a un tiempo anterior, permitiéndote guardar o elegir una opción diferente."
